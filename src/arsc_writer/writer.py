...
def string_pool(values: list[Text]) -> bytes:
    ...
    Raises:
        ValueError: A string exceeds the Android length limit.
...
def generate(package: str, locale: str, resources: ResourceTable) -> bytes:  # ruff: ignore[complex-structure, too-many-locals]
    """
    ...
    Raises:
        ValueError: Resources are empty or inconsistent, plural quantities are invalid,
            the locale is unsupported, or the package name is too long.
